...
- **Importa:** `db`, `inspectionEngine`, `PdfGenerator`, `PharmaParser`, `TacticalMatrix`, `SeizureCalculator`, `components/ui/*`
- **Es usado por:** `InspectionWizard.tsx`
- **Rol en el sistema:** Núcleo operativo. Formulario de captura de datos de inspección.
